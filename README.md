...
&nbsp; - Scopes required: \*\*public\_repo\*\* (public access only)
...
http://127.0.0.1:5000/top-langs?username=YOUR\_GITHUB\_USERNAME
...
https://your-app.up.railway.app/top-langs?username=YOUR\_USERNAME
...
| top\_n    | No       | Number of languages to display (default: 5) |
...
| `GITHUB\_TOKEN` | GitHub PAT for API access |
